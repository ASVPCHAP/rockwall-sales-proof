...
- Hero + sourced proof strip and role-by-role ledger (résumé hard numbers: $160M+ pipeline, Top 1%, $23M quota, $1.5M GTV, ~60% LLM, $81.1M C/W, 89% Horizon3, 16 Rampart partners, Ashley 2× $1M, Health IQ 93%, 5 Star Nutrition 3 locations / $120k+ month / ~$690k year)
...
- Foundations chapter: **5 Star Nutrition** Regional Sales Manager (2018–2021) — Sherman / Oklahoma / Cattle Mills, Texas; West Texas over $120,000/month; around $690,000 in sales; Facebook, SEO, local outreach, field work (not AI). Photo slot reserved.
...
- 5 Star Nutrition operating facts stated by Anthony Chapman (three locations, West Texas $120k+/month, ~$690k year; Facebook / SEO / field work — not AI)
